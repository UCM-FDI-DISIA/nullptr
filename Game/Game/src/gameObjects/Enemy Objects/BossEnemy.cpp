...
void BossEnemy::initGameObject(Vector2D pos, int life, Player* player, CallBack cb) {
	...
	addComponent<HealthComponent>(life)->setKnockBack(false);
	...
	addComponent<ColliderComponent>(_grp_PLAYER, BOSS_COLLIDER_W, BOSS_ENEMY_HEIGHT)->addFunction([&](GameObject* player)
		{

...
void TankEnemy::initGameObject(Vector2D pos, int life, Player* player) {
	...
	auto anim = addComponent<EnemyAnimator>(Constant::getString("TANK_ENEMY_TEXTURE_KEY"), Constant::getInt("TANK_ENEMY_SPRITE_WIDTH"), Constant::getInt("TANK_ENEMY_SPRITE_HEIGHT"),

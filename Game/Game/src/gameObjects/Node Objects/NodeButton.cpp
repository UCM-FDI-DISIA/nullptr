...
void NodeButton::initGameObject(Node* nodeIt, CallBack _cb, Vector2D pos, float navigatorHorMul, std::function<void(Transform*)> onSel) {
	...
	addComponent<NodeButtonComponent>(_cb, nodeIt->getState(), navigatorHorMul)->setOnSelected(onSel);

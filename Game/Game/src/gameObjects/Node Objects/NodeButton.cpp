...
void NodeButton::initGameObject(Node* nodeIt, CallBack _cb, Vector2D pos, float navigatorHorMul) {
	...
	addComponent<NodeButtonComponent>(_cb, nodeIt->getState(), navigatorHorMul);

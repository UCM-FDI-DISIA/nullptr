...
MapScene::MapScene() : GameState() {
	addGameObject<Button>(pasado, SDLApplication::instance(), Vector2D(WIN_WIDTH / 2 - 79, (WIN_HEIGHT / 2 - 30) + 1 * 30), "Pasado", 447, 558, 1, 1);
	addGameObject<Button>(presente, SDLApplication::instance(), Vector2D(WIN_WIDTH / 2 - 79, (WIN_HEIGHT / 2 - 30) + 3 * 30), "Presente", 447, 558, 1, 1);
	addGameObject<Button>(futuro, SDLApplication::instance(), Vector2D(WIN_WIDTH / 2 - 79, (WIN_HEIGHT / 2 - 30) + 5 * 30), "Futuro", 447, 558, 1, 1);

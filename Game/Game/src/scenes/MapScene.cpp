...
MapScene::MapScene() : GameState() {
	...
	addGameObject<Button>(presente, SDLApplication::instance(), Vector2D(WIN_WIDTH / 2, (WIN_HEIGHT / 2 - 30) + 1 * 30), "Pasado", 80, 100, 1, 1, 80, 100);
	addGameObject<Button>(futuro, SDLApplication::instance(), Vector2D(WIN_WIDTH / 2, (WIN_HEIGHT / 2 - 30) + 5 * 30), "Pasado", 80, 100, 1, 1, 80, 100);

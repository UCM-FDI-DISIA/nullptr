...
public:
    ...
    ExplosionBehaviour(int dmg, BattleScene* where, float lifeSpan, grpId trgt) : lifeSpan(lifeSpan), currentLifeDuration(0), scene(where), damage(dmg), tr(nullptr), target(trgt) {}

...
const int PLAYER_ATTACK_IDLE_FRAME_RATE = 7;
//PLAYER ATTACK MOVE ANIM
const int PLAYER_ATTACK_MOVE_INITIAL_FRAME = 16;
const int PLAYER_ATTACK_MOVE_FINAL_FRAME = 23;
const int PLAYER_ATTACK_MOVE_FRAME_RATE = 7;
//PLAYER SKILL IDLE ANIM
const int PLAYER_SKILL_IDLE_INITIAL_FRAME = 24;
const int PLAYER_SKILL_IDLE_FINAL_FRAME = 33;

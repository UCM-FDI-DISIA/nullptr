...
const float FLOOR_WIDTH = 750 * WIN_WIDTH_PER_PIXEL*3; //Dimension horizontal del sprite de suelo
const float FLOOR_HEIGHT = 500 * WIN_HEIGHT_PER_PIXEL*3; //Dimension vertical del sprite de suelo

...
const int MELEE_ENEMY_SPRITE_COLS = 10;

const string MELEE_ENEMY_ATACK = "MeleeEnemyA";
const int MELEE_ENEMY_ATACK_INITIAL_FRAME = 10;
const int MELEE_ENEMY_ATACK_FINAL_FRAME = 17;
const int MELEE_ENEMY_ATACK_FRAME_RATE = 10;

const string MELEE_ENEMY_MOVE = "MeleeEnemyM";
const int MELEE_ENEMY_MOVE_INITIAL_FRAME = 0;
const int MELEE_ENEMY_MOVE_FINAL_FRAME = 9;
const int MELEE_ENEMY_MOVE_FRAME_RATE = 10;

// MELE ENEMY DIMENSIONS
const float MELEE_ENEMY_INITIAL_WIDTH = MELEE_ENEMY_SPRITE_WIDTH * 4;
const float MELEE_ENEMY_INITIAL_HEIGHT = MELEE_ENEMY_SPRITE_HEIGHT * 4;
const Vector2D MELEE_ENEMY_INITIAL_POSITION = { WIN_WIDTH / 2.0f - MELEE_ENEMY_INITIAL_WIDTH / 2, WIN_HEIGHT / 2.0f - MELEE_ENEMY_INITIAL_HEIGHT / 2 };

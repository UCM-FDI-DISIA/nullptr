...
const SDL_Rect GAMEPAD_CONNECTION_RECT = { WIN_WIDTH / 2 - 200 , PERIPHERAL_RECT.y + PERIPHERAL_RECT.h + 10, MM_BUTTON_WIDTH, MM_BUTTON_HEIGHT };
const string GAMEPAD_CONNECTION_TEXT = "Por favor, conecte un mando...";

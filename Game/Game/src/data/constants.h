...
const string CONSTANTS_JSON_ROOT = "../Game/src/data/game.constants.json";
...
//const int BUTTON_FRAME_SPRITE_HEIGHT = 45;
...
//const int MM_BUTTONFRAME_HEIGHT = BUTTON_FRAME_SPRITE_HEIGHT * 3;
...
//const int PM_BUTTONFRAME_HEIGHT = BUTTON_FRAME_SPRITE_HEIGHT * 4;
...
//const int MS_BUTTONFRAME_HEIGHT = BUTTON_FRAME_SPRITE_HEIGHT * 3;
...
//const int IS_BUTTONFRAME_HEIGHT = BUTTON_FRAME_SPRITE_HEIGHT * 2;
...
const Vector2D SYMBOL_POSITIONS[5] = {
	Vector2D(1280 * 5 / 6 - (158 / 2), 310),
	Vector2D(1280 * 5 / 6 - (158 / 2), 380),
	Vector2D(1280 * 5 / 6 - (158 / 2), 450),
	Vector2D(1280 * 5 / 6 - (158 / 2), 520),
	Vector2D(1280 * 5 / 6 - (158 / 2), 590)
};
...
//const Vector2D FLOOR_PAST_VELOCITY = Vector2D();
//
//// STATISTICS FRAME ------------------------------------------------------------------------------
//// KEY ANIMATIONS
...
struct AnimatorInfo {
	...
	int fw, fh;
	int rows, cols;
	//Con constantes para botones genericos
	AnimatorInfo(string _k) : key(_k), w(237), h(54), fw(79), fh(18),
		rows(6), cols(2) { }
	//Con parametros especificos
	AnimatorInfo(string _k, int _w, int _h, int _fw = 79, int _fh = 18,
		int _r = 6, int _c = 2) :

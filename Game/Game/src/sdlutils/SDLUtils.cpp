...
#ifdef _DEBUG
	std::cout << "Initializing SDL_GameController" << std::endl;
#endif
...
#endif
					Relic relicStruct(&images().at(key), key, description, era, stoi(health), stoi(movementVelocity), stoi(cadency), stoi(mana), stoi(attack));
